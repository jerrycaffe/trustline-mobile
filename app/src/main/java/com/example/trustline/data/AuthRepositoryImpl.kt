...
interface AuthRepository {
    ...
    suspend fun otpValidation(otpValidationRequest: OtpValidationRequest): ApiResult<String>
}
...
class AuthRepositoryImpl(
    ...
    override suspend fun otpValidation(otpValidationRequest: OtpValidationRequest): ApiResult<String> {
        return api.makePostCall(
